...
<div class="container-fluid" style="min-height: 100vh">
    <div class="row">
            ...
            <div id="toto">
                ...
                <div class="new__tweet item__border row">
                    ...
                    <div style="margin-left: 10px; width: 100%;">
                        ...
                        <div class="d-flex" style="justify-content: space-between;">
                            <p class="tweet_message mb-0" style="font-family: 'Segoe UI',serif;">Ceci est une description #test</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col right__col messages__result">
            <div class="right__col--content">
                <div class="suggest__msg">
                    <h1 class="suggest__title">Aucun message n'est sélectionné.</h1>
                    <p class="user__pseudo mt-2">Choisissez-en un dans vos messages existants, ou commencez-en un nouveau.</p>
                </div>
            </div>
        </div>
    </div>
