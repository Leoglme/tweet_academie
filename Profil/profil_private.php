...
$obj = new GetInfo($dB);
$obj->getIdUser($_SESSION["login"]);

$nbrFollower = $obj->getNbrFollower($obj->getIdUser($_SESSION["login"]));
$nbrFollow = $obj->getNbrFollowed($obj->getIdUser($_SESSION["login"]));

$registerDate = $obj->getDateRegister($_SESSION['login']);
$countTweet = $obj->countUserTweet($_SESSION['login']);
$bio = $obj->getBio($_SESSION['login']);
            ...
            <div class="row item__border p-0">
                ...
                <div class="user__banner">
                    <div class="user__banner--info">
                        ...
                        <a href="../Edit" class="btn btn-outline-info" type="button">Modifier profil</a>
                    </div>
                </div>
